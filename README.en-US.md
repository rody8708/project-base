...
| Native PHP backend | Framework-free PHP API with SQLite/PostgreSQL/MySQL local profiles, isolated tests, TLS/concurrency and recovery lab. | [Native PHP starter](starters/backend-php-native/README.en-US.md); available in CLI/MCP, not production approved. |
