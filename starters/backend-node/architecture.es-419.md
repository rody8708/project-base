...
Esta plantilla separa dominio y reglas, casos de uso, puertos `TaskRepository`/`TokenRepository`, adaptador SQLite y transporte HTTP. Las dependencias apuntan a contratos internos; cambiar framework o motor no debe cambiar el dominio ni el contrato público.
