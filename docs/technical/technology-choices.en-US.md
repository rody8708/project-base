...
| Custom architecture without an application framework | Particular requirements, direct dependency control, or a minimal base the team can maintain and test. | Executable TypeScript/Node starter; dedicated SQL matrix and HTTPS lab. |
