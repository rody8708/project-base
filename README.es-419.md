...
| Backend PHP propio | API PHP sin framework con perfiles locales SQLite/PostgreSQL/MySQL, pruebas aisladas y laboratorio TLS/concurrencia/recuperación. | [Starter PHP propio](starters/backend-php-native/README.es-419.md); disponible en CLI/MCP, sin aprobación de producción. |
