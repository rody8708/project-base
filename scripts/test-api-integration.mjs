...
import { checkClientContract } from './lib/check-client-contract.mjs';
...
try {
  ...
  await checkClientContract({ url, ownerToken: credential.token, readerToken: reader.token, otherToken: other.token });
